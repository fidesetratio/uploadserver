...
public class FileUploadController {
    ...
    public ResponseEntity<Object> uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        File uploadedFile = new File("/opt/uploadserver/", file.getOriginalFilename());
    ...
    public ResponseEntity<Object> uploadmultipleFile(@RequestParam("files") MultipartFile[] files) {
        ...
        for (MultipartFile multipartFile : files) {
            ...
            File uploadedFile = new File("/opt/uploadserver/", multipartFile.getOriginalFilename());
    ...
    public ResponseEntity<Object> downloadFile(@PathVariable String fileName, HttpServletResponse response) {
        ...
        String filePath = "/opt/uploadserver/" + fileName;
